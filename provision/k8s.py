...
def logs(context, component="ffgpt-backend"):
...
@task
def python_shell(context, component="ffgpt-backend"):
    """Enter into python shell."""
    execute(context, component=component, entry="shell_plus")


@task
def health_check(context, component="ffgpt-backend"):
